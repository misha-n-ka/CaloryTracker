...
class CalculateMealNutrients(
    ...
    operator fun invoke(trackedFoods: List<TrackedFood>): Result {
        ...
        val caloriesInCarbohydrates = 4f
        val carbsGoal = (caloryGoal * userInfo.carbRatio / caloriesInCarbohydrates).roundToInt()
        val proteinGoal = (caloryGoal * userInfo.proteinRatio / caloriesInCarbohydrates).roundToInt()
        val caloriesIntFat = 9f
        val fatGoal = (caloryGoal * userInfo.fatRatio / caloriesIntFat).roundToInt()
