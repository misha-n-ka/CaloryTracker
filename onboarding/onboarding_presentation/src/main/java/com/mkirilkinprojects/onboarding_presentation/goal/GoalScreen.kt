package com.mkirilkinprojects.onboarding_presentation.goal
        ...
        Column(
            ...
            Row(
                ...
                SelectableButton(
                    ...
                    onClick = { viewModel.onGoalTypeSelect(goal = GoalType.LoseWeight) },
                ...
                SelectableButton(
                    ...
                    color = MaterialTheme.colors.primaryVariant,
                    selectedTextColor = Color.White,
                    onClick = { viewModel.onGoalTypeSelect(goal = GoalType.KeepWeight) },
                    textStyle = MaterialTheme.typography.button.copy(fontWeight = FontWeight.Normal)
                )
                SelectableButton(
                    ...
                    color = MaterialTheme.colors.primaryVariant,
                    selectedTextColor = Color.White,
                    onClick = { viewModel.onGoalTypeSelect(goal = GoalType.GainWeight) },
                    textStyle = MaterialTheme.typography.button.copy(fontWeight = FontWeight.Normal)
                )
            }
        }
